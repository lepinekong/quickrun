...
.npm-install: function [
    ...
    mono-install: function [/package >package][
        ...
        either (ans = "O") or locally [
            ...
            ; questions still immutable with parse
            ; parse questions [any [to <%package%> mark: (change/part mark package 11)]]
            ;do http://redlang.red/do-trace
            do-trace 223 [
                ?? package
            ] %npm.7.red            
...
.alias .npm-install [npm-install install]
